...
id: llm-service
title: LLM Service
description: "Language model service providing roadmap planning and sequencing capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for roadmap planning and sequencing. Used by all skills in this skrpt.
